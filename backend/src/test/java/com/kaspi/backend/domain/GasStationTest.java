...
class GasStationTest {
    ...
    void test() {
        ...
        GasStation gasStation1 = new GasStation("A0000035", "서울 종로구", "㈜지에스이앤알 평창주유소", "서울 종로구 평창문화로 135 (평창동)","현대오일뱅크",true);
        attribute = str2.split(",");
        GasStation testGasStation2 = GasStation.parseGasStation(attribute);
        GasStation gasStation2 = new GasStation("A0000045", "서울 종로구", "SK북악주유소", "서울 종로구 평창문화로 137 (평창동)","SK에너지",false);
